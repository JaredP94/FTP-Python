...
\keywords{client, file transfer protocol, server, transmission control protocol, Wireshark}
...
Since the FTP server has two clear parts, the server and the client, the work was divided accordingly. Jared Ping wrote all of the code for the server, as well as the sections in the report pertaining to the server. Kayla-Jade Butkow wrote the code for the client, as well as the sections of the report pertaining to the client. Kayla-Jade also wrote the section pertaining to the commands and reply codes and the introduction, while Jared detailed the structure of the code and wrote the conclusion. The results and critical analysis sections and the abstract were written by the partners together.

\section{RESULTS} \label{sec:results}
In order to test the system, it was necessary to test all of the implemented functionality on both the server and the client, as well as to test the interaction between the server and a standard FTP client, and between the client and a standard FTP server. This functionality was tested by performing actions on the various clients and then viewing the messages sent and corresponding responses received using Wireshark.

The most important functionality to be tested is the ability to log into the server, navigate through the remote file system and upload and download files. Furthermore, the ability to create a directory, delete files and directories and to log out of the server also required testing. Tests for all functions relating to the aforementioned interactions were performed.
...
Since the append command is never sent by the client, if the user tries to upload a file with a name that already exists in the current directory, the pre-existing file will be overwritten. This could result in the accidental loss of user data. Another limitation lies within the file systems in the client GUI. After a file or directory has been modified, it does not update automatically. It needs to be reselected in order for the modifications to be acknowledged and displayed.

\subsection{Future Development}
The server should be enhanced to handle different file structures and transmission modes. The client should implement an automatic refresh every time a file or folder is modified. The functionality of the client should be enhanced to cater for more FTP commands. Finally, the client's compatibility should be enhanced to improve cross-platform support.
...
The server is initialised by running the following command:

\texttt{sudo python ftpserver.py}

The use of \texttt{sudo} corresponds to the server running on command port 21 which requires administrative privileges. The client is initialised by running the following command:
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/Server.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/uploadfile.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/gui.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourServerLogin.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourServerNavigate.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourServerUploadText.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourServerUploadPDF.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourserverDownloadtext.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourserverDownloadPDF.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourServerMKD.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourserverDeleteFile.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourserverdeletefolder.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/ourserverquit.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/multipleConnections.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Appendices/multipleUpload.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/loginWits.png}
	\caption{FTP commands and replies when logging in}
	\raggedright
	\label{fig:loginWits}	
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/navigateWits.png}
	\caption{FTP commands and replies when navigating the remote file system}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/textUploadWits.png}
	\caption{FTP commands and replies when uploading an ASCII type file}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/binaryUploadWits.png}
	\caption{FTP commands and replies when uploading an image type file}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/downloadTextWits.png}
	\caption{FTP commands and replies when downloading an ASCII type file}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/downloadImageWits.png}
	\caption{FTP commands and replies when downloading an image type file}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/makeDirectoryWits.png}
	\caption{FTP commands and replies when creating a directory}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/deleteDirWits.png}
	\caption{FTP commands and replies when deleting a directory}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/deleteFileWits.png}
	\caption{FTP commands and replies when deleting a file}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/logoutWits.png}
	\caption{FTP commands and replies when logging out from the server}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/theirclientLogin.png}
	\caption{FTP commands and replies when logging in}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/theirclientnavigate.png}
	\caption{FTP commands and replies when navigating the remote file system}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/theirclientupload.png}
	\caption{FTP commands and replies when uploading an image type file}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/theirclientdeleteanddownload.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/theirclientMKD.png}
	\caption{FTP commands and replies when creating a directory}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/theirclientRMD.png}
	\caption{FTP commands and replies when deleting a directory}
	\raggedright
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Appendices/theirclientCommandNotKnown.png}
