...
\figref{fig:multiple} shows that the server is able to handle multiple simultaneous connections. It can also be seen that simultaneous uploads and downloads from different users can be performed.
